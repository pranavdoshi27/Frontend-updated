  ...
  return (
    <div>
      <div className="container">
        <div className="main-profilepatient">
          <div className="row">
            <div className="col-md-4 mt-1">
              <div className="cardpatient text-center sidebarpatient">
                <div className="card-body">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="card-body">
                      <div className="row">
                        <div className="text-mainpatient">
                          {props.userData.email}
                        </div>
                      </div>
                      <div className="row">
                        <div className="text-mainpatient">1234567890</div>
                      </div>
                      <div className="row">
                        <div className="text-mainpatient">
            ...
            <div className="col-md-8 mt-1">
              <div className="cardpatient mb-3 contentpatient">
                <h1 class="m-3 pt-3">Medical Information</h1>
                <div className="card-body">
                  <div className="row infopatient">
