...
function MTable(props) {
  console.log(props.doctorappointList);
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className={classes.tableHeaderCell}>Review</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {/* {USERS.slice(
          ...
          {props.doctorappointList
            .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            .map((row) => (
              <TableRow key={row.doctor.name}>
                <TableCell>
                  <Grid container>
                    <Grid item lg={2}>
                      <Avatar
                ...
                <TableCell>
                  <Typography color="primary" variant="subtitle2">
                    <button
                      ...
                      onClick={() => props.reviewHandler(row.doctor.id)}
                    >
                      Write A Review
                    </button>
                  </Typography>
        ...
        <TableFooter>
          <TablePagination
            ...
            component="div"
            count={props.doctorappointList.length}
